    ...
    <div class="col-8 offset-2">
        <form method="POST" action="/newDealer">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="password" class="form-control form-control-sm" id="password_confirmation" name='password_confirmation' placeholder="Password Confirmation">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <select class="custom-select" id='province' name='province' value="{{old('province')}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <select class="custom-select" id='pplan' name='pplan' value="{{old('pplan')}}">
                ...
                <div class="col-sm-4">
                    <input type="email" class="form-control form-control-sm" id="email_address" name='email_address' value="{{old('email_address')}}" required>
                </div>
            </div>
