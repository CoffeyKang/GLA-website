...
<div class="d-flex p2 justify-content-center m-y-5">
    <form action="/addNewnewProduct" class='col-6' method='POST'>
        {{csrf_field()}}
        <div class="form-group row">
            ...
            <div class="col-4"><button class="btn btn-primary btn-block">Add New Products</button></div>
        </div>
    </form>
</div>
    ...
    <tbody>
        ...
        @foreach ($fitems as $item)
            <tr>
                ...
                <td><a href="/deletenewItem/{{$item->id}}" class="btn btn-danger">DELETE</a></td>
            </tr>
        @endforeach
    </tbody>
</table>
