...
<div>
    <div class="alert alert-dark">
        <b>Shipping Order {{$somast->order_num}}</b>
    </div>
    ...
    <div class='d-flex justify-content-center'>
        <form action="/updateShipping"  class='col-md-6' method='POST'>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 ">
                    <label for="track_num">TTrack Number</label>
                    <input type="text" class="form-control" name="track_num" placeholder="Track Number" >
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-12 ">
